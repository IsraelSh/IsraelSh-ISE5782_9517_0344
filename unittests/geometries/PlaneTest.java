...
class PlaneTest {
    ...
    void findIntersections() {
        ...
        assertEquals(List.of(new Point(1,0.5,1)),
                plane.findIntsersections(new Ray(new Vector(1,0,1),new Point(0,0.5,0))),
                "Ray intersects the plane");

        //TC02: Ray does not intersect the plane
        assertNull(plane.findIntsersections(new Ray(new Vector(1,2,5),new Point(1,0.5,2))),
        ...
        assertNull(plane.findIntsersections(new Ray(new Vector(1,0,0),new Point(1,2,1))),
                "Ray is parallel to the plane, the ray included in the plane");

        //TC11: The ray not included in the plane
        assertNull(plane.findIntsersections(new Ray(new Vector(1,0,0),new Point(1,2,2))),
        ...
        assertEquals(List.of(new Point(1,1,1)),
                plane.findIntsersections(new Ray( new Vector(0,0,1),new Point(1,1,0))),
                "Ray is orthogonal to the plane, according to p0, before the plane");

        //TC13: according to 𝑃0, in the plane
        assertNull(plane.findIntsersections(new Ray(new Vector(0,0,1),new Point(1,2,1))),
                "Ray is orthogonal to the plane, according to p0, in the plane");

        //TC14: according to 𝑃0, after the plane
        assertNull(plane.findIntsersections(new Ray(new Vector(0,0,1),new Point(1,2,2))),
        ...
        assertNull(plane.findIntsersections(new Ray( new Vector(2,3,5),new Point(2,4,1))),
        ...
        assertNull(plane.findIntsersections(new Ray( new Vector(2,3,5),new Point(1,0,1))),
