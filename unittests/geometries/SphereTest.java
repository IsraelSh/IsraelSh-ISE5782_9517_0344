...
public class SphereTest {
    ...
    void findIntersections() {
        ...
        assertEquals(List.of(p2),
                sphere.findIntersections(new Ray(new Vector(3,1,0),new Point(0.8, 0.6, 0))),
                "Ray crosses sphere on one point");

        // TC04: Ray starts after the sphere (0 points)
        assertNull(sphere.findIntersections(new Ray( new Vector(1, 1, 0),new Point(3, 0, 0))),
        ...
        assertEquals(List.of(p2),
                sphere.findIntersections(new Ray(new Vector(3,1,0),p1)),
                "Ray starts at sphere and goes inside");

        // TC12: Ray starts at sphere and goes outside (0 points)
        assertNull(sphere.findIntersections(new Ray(new Vector(3,1,0),new Point(2, 0, 0))),
                "Ray starts at sphere and goes inside");

        // **** Group: Ray's line goes through the center
        // TC13: Ray starts before the sphere (2 points)
        assertEquals(List.of(new Point(0, 0, 0), new Point(2, 0, 0)),
                sphere.findIntersections(new Ray( new Vector(1, 0, 0),new Point(-1, 0, 0))),
        ...
        assertEquals(List.of(new Point(2, 0, 0)),
                sphere.findIntersections(new Ray( new Vector(0.5, 0, 0),new Point(1, 0, 0))),
        ...
        assertNull(sphere.findIntersections(new Ray( new Vector(0, 1, 1),new Point(2, -1, -1))),
                "Ray starts before the tangent point");
        // TC20: Ray starts at the tangent point
        assertNull(sphere.findIntersections(new Ray( new Vector(0, 1, 1),new Point(2, 0, 0))),
                "Ray starts at the tangent point");
        // TC21: Ray starts after the tangent point
        assertNull(sphere.findIntersections(new Ray( new Vector(0, 1, 1),new Point(2, 2, 2))),
                "Ray starts after the tangent point");
        // **** Group: Special cases
        // TC19: Ray's line is outside, ray is orthogonal to ray start to sphere's center line
        assertNull(sphere.findIntersections(new Ray( new Vector(0, 0, 1),new Point(3, 0, 0))),
                "Ray starts after the tangent point");
